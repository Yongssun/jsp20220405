...
<form action="ex19carProcess.jsp" method="post">
 ...
 가격: <input type="number" name="price" id=""/> <br /><br />
 사용가능여부: <input type="checkbox" name="available" value="true"/> <br /><br />
  사용자 <button id="addOwnerButton" type="button"><i class="fa-solid fa-plus"></i></button>
...
<c:if test="${empty applicationScope.cars }" var="noCars">
<p class="test-warning"> 등록된 차가 없습니다</p>
</c:if>
<c:if test="${not noCars }">
